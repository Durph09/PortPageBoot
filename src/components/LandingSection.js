...
const LandingSection = ()=> {
  return (
    <Container fluid className="vw-100 vh-100  bg-gradient d-flex justify-content-center align-items-center text-light text-center" style={{backgroundColor: "rgb(42,67,101)"}} >
    <Col>
